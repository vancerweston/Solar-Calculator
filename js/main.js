...
function calculateSolar() {
    ...
    var realWattNeed = realKwNeeds * 1000;
    // console.log(realWattNeed);
    ...
    var panelsNeeded = Math.ceil(realWattNeed / panelOutput);
    // console.log(panelsNeeded);



var feedback = '';
feedback += '<p>Based on your average daily use of '+Math.round(dailyUseKw)+' kWh, you will need to purchase '+panelsNeeded+' '+panelName+' to offset 100% of your electrical bill.</p>';
...
feedback += '<p>Realistic watts needed per hour: '+Math.round(realWattNeed)+' watts/hour.</p>';
